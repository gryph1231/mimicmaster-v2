...
-- File Locals
if not AutomataCacheDB then
  _G.AutomataCacheDB = {};
  AutomataCacheDB.Enabled = true;
end
--- ======= GLOBALIZE =======
-- Addon
AutomataCache = Cache;
...
function Cache.Get(...)
  if AutomataCacheDB.Enabled then
...
function Cache.Set(...)
  return AutomataCacheDB.Enabled and CacheImpl.Set(...) or select(select('#', ...), ...)
end
